...
const Features = ({ type }) => {
	...
	const features = [
		...
		},
		{
			...
			desc: "Une connaissance fine de l'écosystème guinéen et du tissu institutionnel pour faciliter vos démarches.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Des connexions avec investisseurs, partenaires et institutions en Afrique de l'Ouest et au-delà.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Des outils internationaux (MBTI, Big Five) combinés à notre framework MB-JALLOH unique.",
			icon: (
				<svg
					width="80"
					height="81"
							...
							<div className="col-12">
								<div className="sec-heading text-center">
									...
									<div className="desc wow fadeInUp" data-wow-delay="0.3s">
										<p>
											Quatre piliers pour faire de votre projet une réussite
											durable.
										</p>
									</div>
								</div>
