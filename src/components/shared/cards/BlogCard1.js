	...
	return (
		<div className="blog-item wow fadeInUp" data-wow-delay={`0.${idx + 1}s`}>
			...
			<div className="blog-content">
				...
				{idx === 0 ? (
					<div className="desc">
						Dans l'environnement entrepreneurial africain, la clé du succès repose
						sur une planification stratégique et une exécution opérationnelle rigoureuse.
					</div>
				) : (
					""
				)}
