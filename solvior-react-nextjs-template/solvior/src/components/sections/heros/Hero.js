						...
						<div className="hero-wrapper">
							<div className="hero-content">
								<h1 className="hero-title text-anim">
									Votre partenaire indéfectible pour entreprendre en{" "}
									<span className="active-color">Guinée</span>
								</h1>
								<div className="desc wow fadeInUp" data-wow-delay="0.1s">
									<p>
										STAUNCH accompagne entrepreneurs, startups, PME et entreprises étrangères :
										coaching, formation, conseil stratégique, implantation et facilitation institutionnelle.{" "}
									</p>
								</div>
