		...
		<article className="tj-post-item wow fadeInUp" data-wow-delay="0.1s">
			...
			<div className="tj-post-content">
				...
				<div className="tj-post-excerpt">
					Notre mission : accompagner entrepreneurs et entreprises à toutes les étapes de leur projet en Guinée et en Afrique de l'Ouest. Indéfectibles à vos côtés, nous combinons expertise locale, méthodologie internationale et réseau institutionnel solide pour livrer des résultats à fort impact...
				</div>
				<div className="tj-post-btn">
					<ButtonPrimary text={"Lire la suite"} url={`/blogs/${id}`} />
				</div>
			</div>
		</article>
	);
