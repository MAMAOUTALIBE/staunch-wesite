	...
	return (
		...
		>
			...
			<div className="blog-content">
				...
				<div className="desc">
					<p>
						Dans l'environnement entrepreneurial africain, la clé du succès repose sur une planification stratégique et une exécution opérationnelle rigoureuse.
					</p>
				</div>
				<div className="blog-button">
					<Link className="blog-btn text-btn" href={`/blogs/${id}`}>
						Lire la suite <i className="tji-arrow-right"></i>
					</Link>
				</div>
			</div>
		</div>
