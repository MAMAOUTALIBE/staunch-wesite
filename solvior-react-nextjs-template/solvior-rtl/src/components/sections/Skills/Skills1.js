				...
				<div className="row">
					<div className="col-12">
						<div className="skill-wrapper">
							<h2 className="title text-anim">المهارات والخبرة</h2>
							<div className="desc wow fadeInUp" data-wow-delay="0.1s">
								<p>
									في بيئة الأعمال الديناميكية اليوم، يكمن مفتاح النجاح في
									التخطيط الاستراتيجي والتشغيل الفعّال.
								</p>
							</div>
							<div
							...
							>
								<ul className="tj-progress__list style-2 mt-0">
									<li>
										<h6 className="tj-progress__title">استشارات الأعمال</h6>
									...
									<li>
										<h6 className="tj-progress__title">التواصل مع العملاء</h6>
										<div className="tj-progress">
