						...
						<div className="hero-wrapper">
							<div className="hero-content">
								<h1 className="hero-title text-anim">
									تعظيم نمو الأعمال المؤهلة{" "}
									<span className="active-color"> الاستشارية</span>
								</h1>
								<div className="desc wow fadeInUp" data-wow-delay="0.1s">
									<p>
										حوّل عملك من خلال خدمات استشارية احترافية يقدمها فريقنا من
										المستشارين ذوي الخبرة الواسعة.
									</p>
								</div>
